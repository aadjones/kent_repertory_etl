...
def download_page(num, page, output_dir="data/raw"):
    ...
    """
    # Decide the base URL based on the numeric value.
    base_url = "http://homeoint.org/books/kentrep/"
    if num >= 305 and num < 725:
        base_url = "http://homeoint.org/books/kentrep1/"
    elif num >= 725 and num < 1075:
        base_url = "http://homeoint.org/books/kentrep2/"
    elif num >= 1075:
        base_url = "http://homeoint.org/books/kentrep3/"
